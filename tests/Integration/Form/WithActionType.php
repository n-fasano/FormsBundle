...
class WithActionType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults(
            array (
              'action' => '/example',
              'data_class' => 'Fasano\\FormsBundle\\Tests\\Integration\\Cases\\WithAction',
              'constraints' => 
              array (
              ...
              'empty_data' => function (FormInterface $form) {
                try {
                    return new \Fasano\FormsBundle\Tests\Integration\Cases\WithAction(...array_values(array_map(
